...
/**
 * The file add for bug which can't show gif/bmp file, and the file has large header(>5MB).
 * Prevents {@link InputStream InputStreams} from overflowing their buffer
 * by reading data past their read limit.
 */
